                ...
                <div class="col-sm-6">
                    <div class="contactinfo">
                        <ul class="nav nav-pills">
                            <li><a href="#"><i class="fa fa-phone"></i> +38 063 242 30 59</a></li>
                            <li><a href="#"><i class="fa fa-envelope"></i> si4kar@gmail.com</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-sm-6">
            ...
            <div class="row">
                <div class="col-sm-4">
                    <div class="logo pull-left">
                        <a href="/"><img src="/webroot/images/home/logo.png" alt="" /></a>
                    </div>
                </div>
                <div class="col-sm-8">
                    <div class="shop-menu pull-right">
                        <ul class="nav navbar-nav">
                            ...
                            <li><a href="/cabinet/index/"> <i class="fa fa-lock"></i><?php echo implode("','", Session::get('login'));?> </a></li>
                                <li><a href="/cabinet/exit/"><i class="fa fa-user"></i> Выход</a></li>
                            <?php } else { ?>
